...
public class Slider extends Component {
	...
	public void render(MatrixStack matrics, int mouseX, int mouseY, float delta) {
		...
		DrawableHelper.fill(matrics, parent.parent.x, parent.parent.y + parent.offset + offset, parent.parent.x + renderWidth, parent.parent.y + parent.offset + offset + parent.parent.height, Color.CYAN.getRGB());
		...
		mc.textRenderer.drawWithShadow(matrics, numSet.getName() + ": " + roundToPlace(numSet.getValue(), 2), parent.parent.x + textOffset, parent.parent.y + parent.offset + offset + textOffset, -1);
